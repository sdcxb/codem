...
> 创建时间：2026-07-23 | 最后更新：2026-09-07 | 当前版本：v1.9.9（EAC 对标：编辑并回退/节点导航升级+精选 pin/输入框失焦折叠/persona 人设卡/side-session 临时会话/@codem/agent-teams 团队编排；差距矩阵 docs/EAC-GAP-ANALYSIS.md，验证清单 docs/EAC-VERIFICATION.md；含 v1.9.8 对话用量/缓存命中率真实化 + date 尾置稳定前缀优化，2026-09-07）
>
