...
> 创建时间：2026-07-23 | 最后更新：2026-09-09 | 当前版本：v1.11.2（zg 在线安装 Node 源根治——Node 随 zg 单包发布、仅从 GitHub 取包；审计四坑修复：真 PPTX 导出 / 纠偏模型接线 / Whisper 双引擎语音入口 / 会话内搜索激活；功能文档体系：介绍 20 域 152 亮点 + 全量功能树 2779 项）
>
