...
> 创建时间：2026-07-23 | 最后更新：2026-09-07 | 当前版本：v1.10.0（EAC 对标 DSH-Desktop-EAC 四项：④宠物大肥鱼式状态卡 / ③@codem/computer-use 电脑操作 / ②@codem/wechat-bridge 微信 ClawBot 桥（iLink）/ ①@codem/phone-link 手机连接（LAN HTTP 地基）；四路只读审计修复（P0 computer-use PS 断链/宠物卡隐藏/插件禁用=关闭真实生效/executor 失败落库等）；实施记录 docs/EAC-PHASE2-STATUS.md，差距矩阵 docs/EAC-GAP-ANALYSIS.md）
>
