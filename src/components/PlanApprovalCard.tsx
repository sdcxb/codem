        ...
        <div style={{
          ...
          {showFeedback ? (
            <>
              ...
              <button onClick={() => onReject(feedback)} style={{ ...btnStyle, background: "var(--error)", color: "var(--text-on-accent)", border: "none" }}>
            ...
            <>
              ...
              <button onClick={onApprove} style={{ ...btnStyle, background: "var(--success)", color: "var(--text-on-accent)", border: "none" }}>
