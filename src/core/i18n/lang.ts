...
search: { zh: "搜索", en: "Search" },
    ...
    openInFileManager: { zh: "在文件管理器中打开", en: "Open in File Manager" },
    removeProject: { zh: "移除项目", en: "Remove Project" },
  ...
  bubble: {
    ...
    cleanFiles: { zh: "清理过程文件", en: "Clean up files" },
  ...
  cicd: {
    ...
    load: { zh: "加载", en: "Load" },
    tokenMissing: { zh: "未配置 GitHub Token，请在 设置 → Git 偏好配置 中添加", en: "GitHub Token not configured. Add it in Settings → Git Preferences." },
